...
#define N_MOT_MAX       1100            // [rpm] Maximum motor speed limit
...
#define FIELD_WEAK_LO   950             // ( 500, 1000] Input target Low threshold for starting Field Weakening / Phase Advance. Do NOT set this higher than 1000.
