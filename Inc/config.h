...
#define N_MOT_MAX       1456            // [rpm] Maximum motor speed limit
...
#define PHASE_ADV_MAX   38              // [deg] Maximum Phase Advance angle (only for SIN). Higher angle results in higher maximum speed.
...
#define FIELD_WEAK_LO   1             // ( 500, 1000] Input target Low threshold for starting Field Weakening / Phase Advance. Do NOT set this higher than 1000.
